...
@conf
def check_doxygen(self, **kw):
    '''
    Check if doxygen and tar commands are present in the system

    If command are present, then HAVE_DOXYGEN and HAVE_TAR will be set
    '''

    self.find_program('doxygen', var='DOXYGEN', **kw)
    self.find_program('tar', var='TAR', **kw)
